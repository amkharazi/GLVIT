...
from Models.timm_ours_v3 import VisionTransformer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--attention_method', type=str, default='default', help='attention method')
    ...
    main(args.dataset, args.TEST_ID, args.batch_size, args.n_epoch, args.image_size, args.train_size,
         args.patch_size, args.num_classes, args.dim, args.depth, args.heads, args.mlp_dim,args.second_patch_size,args.seed, args.print_w, args.attention_method)
