...
def main(dataset = 'cifar10', 
    ...
    if dataset == 'cifar10':
        ...
        train_loader, test_loader = get_cifar10_dataloaders('../datasets', transform_train, transform_test, batch_size, image_size, train_size, repeat_count=5)
    ...
    if dataset == 'cifar100':
        ...
        train_loader, test_loader = get_cifar100_dataloaders('../datasets', transform_train, transform_test, batch_size, image_size, train_size, repeat_count=5)
    ...
    if dataset == 'mnist':
        ...
        train_loader, test_loader = get_mnist_dataloaders('../datasets', transform_train, transform_test, batch_size, image_size, train_size, repeat_count=5)
    ...
    if dataset == 'tinyimagenet':
        ...
        train_loader, test_loader, _ = get_tinyimagenet_dataloaders('../datasets', transform_train, transform_val, transform_test, batch_size, image_size, repeat_count=5)
    ...
    if dataset == 'fashionmnist':
        ...
        train_loader, test_loader = get_fashionmnist_dataloaders('../datasets', transform_train, transform_test, batch_size, image_size, train_size, repeat_count=5)
    ...
    if dataset == 'flowers102':
        ...
        train_loader, test_loader = get_flowers102_dataloaders('../datasets', transform_train, transform_test, batch_size, image_size, train_size, repeat_count=5)
    ...
    if dataset == 'oxford_pets':
        ...
        train_loader, test_loader = get_oxford_pets_dataloaders('../datasets', transform_train, transform_test, batch_size, image_size, train_size, repeat_count=5)
    ...
    if dataset == 'stl10':
        ...
        train_loader, test_loader = get_stl10_classification_dataloaders('../datasets', transform_train, transform_test, batch_size, image_size, train_size, repeat_count=5)
    ...
    best_top1_acc = 0.0
    best_model_path = os.path.join(result_dir, 'model_stats', 'best_model.pth')
    ...
    for epoch in range(0+1,n_epoch+1):
        ...
        report_test, top1_acc = test_epoch(test_loader, epoch)
        # top1_acc = float(top1_acc)
    
        report_train_to_save = report_train + '\n'
        report_test_to_save = report_test + '\n'
        
        if top1_acc > best_top1_acc:
            best_top1_acc = top1_acc
            torch.save(model.state_dict(), best_model_path)
            print(f"New best model saved with top1 accuracy at epoch ${epoch}: {best_top1_acc:.4f}")
